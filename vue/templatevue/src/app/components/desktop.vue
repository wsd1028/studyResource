  ...
  <div class="desktop">
    <el-dialog :visible.sync="addDialogVisible" width="30%" title="新增">
      ...
      >
        ...
        <el-form-item label="内存(GB)" prop="contactPhone">
          <el-input v-model="addForm.contactgPhone" auto-complete="off"></el-input>
        </el-form-item>
        <el-form-item label="硬盘(SAS)" prop="contactPhone">
    ...
    <header>
      ...
      <el-breadcrumb separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item>云桌面资费管理</el-breadcrumb-item>
      </el-breadcrumb>
    </header>
    <section>
      ...
      >
        ...
        <el-table-column prop="address" label="内存(GB)"></el-table-column>
        <el-table-column prop="address" label="硬盘(SAS)"></el-table-column>
