<template>
  <div class="hardDiskBack">
    <el-dialog :visible.sync="addDialogVisible" width="30%" title="新增">
      ...
      >
        <el-form-item label="产品名称" prop="custName">
    ...
    <header>
      ...
      <el-breadcrumb separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item>云硬盘备份资费管理</el-breadcrumb-item>
      </el-breadcrumb>
    </header>
    <section>
...
@Component
export default class HardDiskBack extends Vue {
  private tableData = [
    {
      date: "ij"
    }
