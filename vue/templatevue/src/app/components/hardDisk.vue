  ...
  <div class="hardDisk">
    <el-dialog :visible.sync="addDialogVisible" width="30%" title="新增">
      ...
      >
        ...
        <el-form-item label="包月标准价格(G/月)" prop="number0">
          <el-input v-model="addForm.number0" auto-complete="off"></el-input>
        </el-form-item>
        <el-form-item label="按需标准价格(元/G/小时)" prop="number0">
          <el-input v-model="addForm.number0" auto-complete="off"></el-input>
        </el-form-item>
        <el-form-item>
    ...
    <el-dialog :visible.sync="updateDialogVisible" width="30%" title="修改">
      ...
      >
        ...
        <el-form-item label="按需标准价格(元/G/小时)" prop="contactPhone">
    ...
    <header>
      ...
      <el-breadcrumb separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item>云硬盘资费管理</el-breadcrumb-item>
      </el-breadcrumb>
    </header>
    <section>
      ...
      >
        ...
        <el-table-column prop="address" label="包月标准价格(G/月)"></el-table-column>
        <el-table-column prop="address" label="按需标准价格(元/G/小时)"></el-table-column>
...
@Component
export default class HardDisk extends Vue {
  private tableData = [
    {
      date: "ij"
    }
