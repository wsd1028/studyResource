<template>
  <div class="government-problemReport mainBox">
    <div class="mainTop">
...
export default {
  ...
  methods: {
    ...
    async select(page) {
      ...
      let resp = await this.$http.get('/carp/business/a/q/question/report/page', {
