<template>
  <div
    ...
    class="systemRole"
  >
    <el-dialog :visible.sync="uploadDialogVisible" width="951px" center @close="uploadDialogNo">
      ...
      <div class="top-left">
        ...
        <div>
          ...
          <el-dialog :visible="true">
            <el-button type="primary" size="small" @click="uploadTem('templete/系统角色模板.xls')">下载模板</el-button>
            <el-upload
    ...
    <el-table :data="PageData" class="marginTop" v-loading="loading" border>
